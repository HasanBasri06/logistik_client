            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-2xl font-bold text-gray-900">{{ totalCallRequests }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <section class="rounded-2xl border border-gray-200 bg-white shadow-sm">
                    <div class="border-b border-gray-100 px-5 py-4">
                        <div class="flex items-center justify-between gap-3">
                            <h2 class="text-base font-semibold text-gray-900">Bugün Kayıt Olanlar</h2>
                    ...
                    <div class="max-h-[420px] overflow-y-auto p-4">
                        <p v-if="!todayUsers.length" class="py-8 text-center text-sm text-gray-500">
                            Bugün kayıt olan kullanıcı yok.
                        </p>
...
async function loadDashboard() {
    ...
    try {
        ...
        totalCallRequests.value = result.totalCallRequests;
